import {msgConvert} from "../QuotaSet/constant";
...
type TAddConditionItem = {
    name: string;
    text: string;
    expandable: boolean;
    keyString: string;
    conditionTypes: TConditionType[]
}

type TAddCondition = {
    [k in 'convert' | 'ycCondition' | 'yxCondition']: TAddConditionItem
}

export const addConditions: TAddCondition = {
    convert: {
